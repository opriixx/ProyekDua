...
//  Challenge1
//
//  Created by Muhammad Ridwan Novriansyah on 23/04/26.
//
...
struct YourTurnView: View {
    ...
    @State private var goDiscussion = false
    ...
    var body: some View {
        ...
        .navigationDestination(isPresented: $goDiscussion) {
            DiscussionTimeView()
        }
...
extension YourTurnView {
    
    func antrianimasi() async {
